...
namespace SimpleBroker
{
    ...
    public class Broker
    {
        ...
        ///     <example>
        ///         <i>
        ///             Example use: get 500 "last" ticks, beginning at market open on January 8,
        ///             2024:
        ///         </i>
        ///         <code>
        ///             Contract contract = new()
        ...
        ///             };
        ///
        ///             var ticks = await GetHistoricalTicksLast(
        ///                 contract,
        ///                 "20240108 09:30:00",
        ///                 "",
        ///                 500,
        ...
        )
        {
            ...
            var handler = Handlers.HistoricalTicksLastHandler(ticks, reqId, tcs, contract.Symbol);
        ...
        ///                 Currency = "USD"
        ///             };
        ///             var bars = await GetHistoricalTicksMid(
        ///                 contract,
        ///                 "20240108 09:30:00",
        ///                 "",
        ///                 500,
        ...
        )
        {
            ...
            var handler = Handlers.HistoricalTicksMidHandler(ticks, reqId, tcs, contract.Symbol);
